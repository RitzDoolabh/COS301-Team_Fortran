...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{Navigation_Sequence_Diagram.png}
\end{figure}
...
\begin{figure}[h!]
  \includegraphics[width=\textwidth]{Navigation_Activity_Diagram.png}
\end{figure}
...
\begin{figure}[h!]
  \includegraphics[width=0.55\textwidth]{Navigation_State_Diagram.png}
\end{figure}
