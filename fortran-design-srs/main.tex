...
\begin{figure}[h!]
        \begin{center}
            \includegraphics[width=1.0\textwidth]{class_diagram.png} \caption{Points Of Interest Class Diagram}
        \end{center}
    \end{figure}
...
\begin{figure}[h!]
        \begin{center}
            \includegraphics[width=1.0\textwidth]{sequantial_Diagram.png} \caption{Points of Interest Sequential Diagram}
        \end{center}
    \end{figure}
