...
Google Maps - Google Maps will be used to aid the navigation process within the application so that coordiantes can be sent to the server for processing on the UP Campus Map. 
\end{itemize}
\newpage
